...
ComponentInterface* ComponentFactory::createFrom(std::string path)
{
    ...
    if(load)
    {
        ...
        /*puntero a funcion que retorna un componente*/
        ComponentFactory factory = ( ComponentFactory ) loaderObject->getExternalFunction( "create" );
        /* el cargador llama a funcion obtener funcion externa crate. para crear un componente
        application. lib/Application/Application.cpp*/
